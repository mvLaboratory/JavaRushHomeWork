...
{
    static HashMap<String, Class<? extends Hen>> henMap = new HashMap<String, Class<? extends Hen>>() {{
        put(Country.BELARUS, BelarusianHen.class);
        put(Country.MOLDOVA, MoldovanHen.class);
        put(Country.UKRAINE, UkrainianHen.class);
        put(Country.RUSSIA, RussianHen.class);
    }};
    ...
    static class HenFactory {
        ...
        static Hen getHen(String country) {
            ...
            try
            {
                hen = henMap.get(country).newInstance();
            }
