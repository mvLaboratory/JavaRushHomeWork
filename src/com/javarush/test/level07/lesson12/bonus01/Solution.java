    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            dataRead : {
                ...
                if (sAge.isEmpty()) break dataRead;
                else age = Integer.parseInt(sAge);

                String sWeight = reader.readLine();
                if (sWeight.isEmpty()) break dataRead;
                else weight = Integer.parseInt(sWeight);

                String sTailLength = reader.readLine();
                if (sTailLength.isEmpty()) break dataRead;
                else tailLength = Integer.parseInt(sTailLength);
            }
